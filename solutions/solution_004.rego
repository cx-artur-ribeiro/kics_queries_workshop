...
CxPolicy[result] {
	...
	keyToCheck := get_module_equivalent_key("aws", module.source, resourceType, "policy")
	allows_action_from_all_principals(module[keyToCheck], "delete")
	...
	result := {
		...
		"searchLine": build_search_line(["module", name, "policy"], []),
	}
}
